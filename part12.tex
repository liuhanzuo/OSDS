...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{fig/resize_latency.png}
    \caption{Resize: Latency Distribution.}
    \label{fig:enter-label}
\end{figure}
...
\begin{itemize}
    \item Most latencies focus on a narrow time slice centering at about 1 second; this shows that our queue implementation is steady and can handle request efficiently for most requests.
    \item There are still requests costing more than 20 seconds; this is caused by getting blocked.
\end{itemize}
